...
{
    loadLanguage();
    setWindowTitle(lang("追光者 Lumen Arc v1.15.2", "Lumen Arc v1.15.2") + buildStamp());
    resize(1280, 720);
    ...
    connect(m_videoListPanel, &VideoListPanel::videoCountChanged,
            this, [this](int count) {
                ...
                setWindowTitle(windowTitleWithCase(
                    lang("追光者 Lumen Arc v1.15.2", "Lumen Arc v1.15.2")));
                updateTimeDisplay();
...
void MainWindow::exitCaseMode()
{
    ...
    if (m_batchRelocateAction)
        m_batchRelocateAction->setEnabled(false);
    setWindowTitle(lang("追光者 Lumen Arc v1.15.2", "Lumen Arc v1.15.2"));
...
void MainWindow::openVideoFile(const QString &filePath)
{
    ...
    if (filePath.endsWith(".vla", Qt::CaseInsensitive)) {
        ...
        setWindowTitle(windowTitleWithCase("Lumen Arc v1.15.2 - [Loaded: " +
