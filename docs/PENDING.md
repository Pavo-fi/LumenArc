...
| P-50 | 拼接假成功修复待真机：损坏素材目录重跑 → 报"产物时长异常：源文件可能数据损坏"且不落盘坏文件（已修 `c1aa169`） | HANDOVER §45 | ☐ |
| P-51 | 后门对面目录源文件损坏（`000131_100.mp4`/`002133_100.mp4`）：需用户重新导出/拷贝后重跑拼接 | HANDOVER §45 | ☐ 用户侧 |
