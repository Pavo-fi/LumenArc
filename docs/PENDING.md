...
| P-57 | **多视频同步播放（多机时间线合并）**：方案 v0.3 **已拍板定稿**（2026-08-18 两轮：2-4 路无硬门槛/独立大窗口/2 路允许临时进[会话级手动对齐不落盘，含以声定点]/模式A 合并时间线实时追逐 vs 模式B 分开进度条/音频单路可切听/瓦片 OSD 开关/双击回单路/**N-7 瓦片放大镜滚轮+中键**/性能三级治理[硬解优先→lowres 预览档→提示]）——docs/MULTICAM_PLAYBACK_TECH_DESIGN_CN.md；粗估 8-10 人日，M1-M4 | §51 用户提需 | ✅ 已拍板（待施工排期） |
