...
call "%VS_VCVARS%"
cl /EHsc /std:c++17 /Zc:__cplusplus /permissive- /MD /O2 /utf-8 manual2docx.cpp ..\..\src\infrastructure\docx_writer.cpp ..\..\src\infrastructure\zip_store_writer.cpp /I "%QT_DIR%\include" /I "%QT_DIR%\include\QtCore" /I "%QT_DIR%\include\QtGui" /I "..\.." /link /LIBPATH:"%QT_DIR%\lib" Qt6Core.lib Qt6Gui.lib
exit /b %errorlevel%
