...
- **当前 HEAD**：施工批（2026-08-19 §56 多机播放窗原生最小化/最大化按钮[用户布置，截图拍板]；版本 v1.10.0）
...
- **全回归基线**（13 套，v1.10.0 施工批）：mw **65**（+P-57 UI 链 14 + P-59 新手流程 19
  +保存合并 5，LUMENARC_REPRO_VIDEO 门控 +1）/ task_registry 41 / case 248 /
