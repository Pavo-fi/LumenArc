...
- **当前 HEAD**：施工批（2026-08-21 §61 GO 链双根因修复[按 GO 不走 OCR 智能排序]；版本 **v1.12.2**）
...
- **全回归基线**（14 套，v1.12.2 施工批）：mw **78**（+GO 链回归 13）/ task_registry 41 /
  case 248 / case_e2e 51 / piecewise 96 / preprocess 268 / ui_chain 92 /
  calibration 77 / roi_model 23 / vla v10 累计 40 / libav 32（无 caltest 素材
  环境跑 20）/ v17 37 / sync 96 / sidecar 34
- **当前保留批次**（新→旧，R2 限 5 批）：
  第五十二批 §61（GO 链双根因修复：链式标志被会话复位吞掉 + 列表序中间态
  evidenceReady 误直通，版本→1.12.2）·
...
- **最近归档动作**：2026-08-21 §61 批——第四十七批（§56）移入 WORK_HISTORY.md 末尾；
  早前：§60 批——第四十六批（§55）移入；§59 批——第四十五批（§54）移入。
