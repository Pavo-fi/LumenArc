...
- **全回归基线**（**17 套**，v1.14.0 施工批）：mw 97 / task_registry 41 / case 248 /
  ...
  环境跑 20）/ v17 37 / **sync 193（含 P-69 合并轨 44 + P-73 引导 9/可听集 5）**/ sidecar 34 / segment 54 / **docx 23 + report 37（P-28 批次①②）**
- **当前保留批次**（新→旧，R2 限 5 批）：
...
**遗留（批次③）**：报告向导（勾章节+补录元数据审核/批准/送检人+附件图）、
图表/语谱图整段光栅嵌入、生成进度条（大文件哈希）、P-74 点位图编辑器施工。
